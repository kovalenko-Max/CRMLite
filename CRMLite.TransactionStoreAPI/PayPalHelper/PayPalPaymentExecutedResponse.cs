...
namespace CRMLite.TransactionStoreAPI.PayPalHelper
{
    public class PayPalPaymentExecutedResponse
    {
        ...
        public class Sale
        {
            ...
            public string protection_eligility { get; set; }
            public string protection_eligility_type { get; set; }
            public Transaction_Fee transaction_Fee { get; set; }
            public string patent_payment { get; set; }
            public DateTime create_timev { get; set; }
            public DateTime update_timev { get; set; }
            public Link[] links { get; set; }
